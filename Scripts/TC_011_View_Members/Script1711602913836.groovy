...
Mobile.tap(findTestObject('Object Repository/PG_011_View_Members/1. Element - Members'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/PG_011_View_Members/2. Wait For Element - Search'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/PG_011_View_Members/3. Verify - Members Name', [('MembersName') : PeopleName]), PeopleName)

Mobile.tap(findTestObject('Object Repository/PG_011_View_Members/4. Icon - Close'), 0)

Mobile.tap(findTestObject('Object Repository/PG_011_View_Members/5. Button - Done'), 0)
