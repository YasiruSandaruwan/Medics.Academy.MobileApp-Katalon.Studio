...
Mobile.tap(findTestObject('Object Repository/PG_025_Delete Account/1. Button - Delete account'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/PG_025_Delete Account/2. Verify Element - Confirmation Msg'), 
    'You are about to delete your account. Are you sure you want to do this?')

Mobile.tap(findTestObject('Object Repository/PG_025_Delete Account/3. Confirmation Button - Ok'), 0)
