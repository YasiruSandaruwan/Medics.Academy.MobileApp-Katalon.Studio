...
Mobile.tap(findTestObject('Object Repository/PG_017_Delete Message/2. Wait For Element - Delete message'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/PG_017_Delete Message/3. Verify - Element Msg'), 'Are you sure you want to delete this message?')

Mobile.tap(findTestObject('Object Repository/PG_017_Delete Message/4. Button confirm - YES'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/PG_017_Delete Message/5. Verify Element - Message deleted'), 
    'Message deleted')
