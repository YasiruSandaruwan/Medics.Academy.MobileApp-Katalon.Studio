...
Mobile.scrollToText('Pin to channel')

Mobile.tap(findTestObject('Object Repository/PG_021_Pin to Channel/1. Buttton - Pin to channel'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/PG_021_Pin to Channel/2. Verify Element - Pinned by you'), 'Pinned by you')
