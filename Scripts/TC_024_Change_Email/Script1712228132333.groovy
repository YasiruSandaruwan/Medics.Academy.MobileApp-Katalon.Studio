...
Mobile.scrollToText('Change email')

Mobile.tap(findTestObject('Object Repository/PG_024_Change Email/1. Button - Change email'), 0)

Mobile.setText(findTestObject('Object Repository/PG_024_Change Email/2. Enter- New email'), NewEmail, 0)

Mobile.setText(findTestObject('Object Repository/PG_024_Change Email/3. Eneter - Current Email'), CurrentEmail, 0)
