...
Mobile.tap(findTestObject('PG_015_Auto-enrollment Channel/1. Check - Auto - enrollment'), 0)

Mobile.verifyElementChecked(findTestObject('PG_015_Auto-enrollment Channel/1. Check - Auto - enrollment'), 0)

Mobile.scrollToText('Done')

Mobile.tap(findTestObject('PG_012_Mute Channel/3. Button - Done'), 0)
