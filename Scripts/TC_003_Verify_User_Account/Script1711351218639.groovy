...
//Verify First Name
Mobile.verifyElementText(findTestObject('Object Repository/PG_004_Medics User Account/1. Verify - First Name'), FistName)

//Verify Last Name
Mobile.verifyElementText(findTestObject('Object Repository/PG_004_Medics User Account/2. Verify - Last Name'), LastName)

//Verify Chat display Name
Mobile.verifyElementText(findTestObject('Object Repository/PG_004_Medics User Account/3. Verify - Chat Display Name'), ChatDisplayName)

//Verify Email Address
Mobile.verifyElementText(findTestObject('PG_004_Medics User Account/4. Verify - Email Address'), GlobalVariable.Email)
