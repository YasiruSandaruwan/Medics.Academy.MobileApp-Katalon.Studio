...
Mobile.scrollToText('Mute channel')

Mobile.tap(findTestObject('Object Repository/PG_012_Mute Channel/1. Switch - Mute Channel'), 0)

Mobile.verifyElementChecked(findTestObject('Object Repository/PG_012_Mute Channel/1. Switch - Mute Channel'), 0)

Mobile.tap(findTestObject('Object Repository/PG_012_Mute Channel/3. Button - Done'), 0)
