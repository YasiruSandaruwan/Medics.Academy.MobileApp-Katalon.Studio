...
Mobile.tap(findTestObject('Object Repository/PG_009_Leave From Channel/2. Button - Leave channel'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/PG_009_Leave From Channel/3. Wait For Element - Are you sure you want to leave this channel'), 
    0)

Mobile.tap(findTestObject('Object Repository/PG_009_Leave From Channel/4. Button Confirm - Yes'), 0)
