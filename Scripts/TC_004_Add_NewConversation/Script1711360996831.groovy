...
Mobile.tap(findTestObject('PG_005_Add New Conversation/1. Icon - Plus mark'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/PG_005_Add New Conversation/2. Wait For Elemnt - New Conversation'), 
    0)

Mobile.scrollToText(ConversationName)

Mobile.tap(findTestObject('PG_005_Add New Conversation/3. Element - Conversation Name', [('ConversationName') : ConversationName]), 
    0)

Mobile.tap(findTestObject('Object Repository/PG_005_Add New Conversation/4. Button - Add'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/PG_005_Add New Conversation/5. Wait For Element - Add Conversation msg' ,[('ConversationNameMsg') : ConversationName]), 
    0)
