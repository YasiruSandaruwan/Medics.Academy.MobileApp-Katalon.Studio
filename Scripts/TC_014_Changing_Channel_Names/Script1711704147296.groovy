...
Mobile.setText(findTestObject('Object Repository/PG_014_Changing Channel Name/1. Element - New Channel Name', [('OldChannelName') : ChannelName]), 
    NewChannelName, 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/PG_014_Changing Channel Name/2. Button - After Edit Done'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/PG_014_Changing Channel Name/3. Wait For Element - Are you sure you want to edit the channel details'), 
    0)

Mobile.tap(findTestObject('Object Repository/PG_014_Changing Channel Name/4. Button - Ok'), 0)

Mobile.tap(findTestObject('Object Repository/PG_014_Changing Channel Name/2. Button - After Edit Done'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/PG_014_Changing Channel Name/5. Verify - New Channel Name', [('newChannel') : NewChannelName]), NewChannelName)
