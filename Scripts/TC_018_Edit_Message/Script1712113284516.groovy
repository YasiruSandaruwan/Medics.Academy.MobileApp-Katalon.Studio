...
Mobile.tap(findTestObject('Object Repository/PG_018_Edit Message/1. Button - Edit message'), 0)

Mobile.setText(findTestObject('Object Repository/PG_018_Edit Message/2. Set - Edit Msg',[('OldMsg') : MsgName]), EditMsg, 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/PG_018_Edit Message/3. New Msg - Sent'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/PG_018_Edit Message/4. Verify Element - Edit Msg', [('NewMsg') : EditMsg]), EditMsg)
