...
Mobile.scrollToText('Delete channel')

Mobile.tap(findTestObject('Object Repository/PG_016_Delete Channel/1. Button - Delete channel'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/PG_016_Delete Channel/2. Verify - Confirmation Msg'), 'Are you sure you want to permanently delete this channel?')

Mobile.tap(findTestObject('Object Repository/PG_016_Delete Channel/3. Click Button - Yes'), 0)
