...
Mobile.setText(findTestObject('PG_006_Send Message/2. Msg Box - Send a message'), MsgName, 0)

Mobile.tap(findTestObject('PG_006_Send Message/3. Icon - Msg Send'), 0)

Mobile.verifyElementText(findTestObject('PG_006_Send Message/4. Verify Element - Send Msg', [('SendMsg') : MsgName]), MsgName)

Mobile.hideKeyboard()

/*Mobile.tapAndHold(findTestObject('Object Repository/PG_017_Delete Message/1. Double tap - Message', [('DeleteMsg') : MsgName]), 
    0)*/
Mobile.waitForElementPresent(findTestObject('Object Repository/PG_017_Delete Message/2. Wait For Element - Delete message'), 
    0)

Mobile.tap(findTestObject('Object Repository/PG_019_Forward Message/1. Button - Forward'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/PG_019_Forward Message/2. Wait For Element - Forward'), 0)

Mobile.tap(findTestObject('Object Repository/PG_019_Forward Message/3. Click - Forward Name',[('ForwardName') : ForwardPersonName]), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/PG_019_Forward Message/4. Wait For Element- Send a message'), 
    0)

Mobile.verifyElementText(findTestObject('Object Repository/PG_019_Forward Message/5. Verify - Forwarded Element',[('ForwardMsg') : MsgName]), MsgName+' (Forwarded)')
