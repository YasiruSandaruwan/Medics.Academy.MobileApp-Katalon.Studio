...
Mobile.scrollToText('Reply in thread')

Mobile.tap(findTestObject('Object Repository/PG_020_Reply in thread Message/1. Button - Reply in thread'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/PG_020_Reply in thread Message/2. Wait For Element - Thread'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/PG_020_Reply in thread Message/3. Verify Element - Msg',[('ThreadMsg') : MsgName]), MsgName)

Mobile.tap(findTestObject('Object Repository/PG_020_Reply in thread Message/4. Close - button'), 0)
